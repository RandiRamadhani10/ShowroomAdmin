            ...
            <div class="header-left">
              ...
              <div class="dropdown for-message">
                ...
                <div class="dropdown-menu" aria-labelledby="message">
                  <p class="red">You have 3 Mails</p>
                  <a class="dropdown-item media" href="#">
                    <span class="photo media-left"><img alt="avatar" src="images/avatar/1.jpg" /></span>
                    <div class="message media-body">
                      <span class="name float-left">Farhan Adi</span>
                      <span class="time float-right">Baru saja</span>
                      <p>Helo admin</p>
                    </div>
                  </a>
                  <a class="dropdown-item media" href="#">
                    ...
                    <div class="message media-body">
                      <span class="name float-left">Friti Septiani</span>
                      <span class="time float-right">5 menit yang lalu</span>
                      <p>Apakah barang masih tersedia?</p>
                    </div>
                  </a>
                  <a class="dropdown-item media" href="#">
                    <span class="photo media-left"><img alt="avatar" src="images/avatar/3.jpg" /></span>
                    <div class="message media-body">
                      <span class="name float-left">Caca marisa</span>
                      <span class="time float-right">10 menit yang lalu</span>
                      <p>Hello, Apakah barang masih tersedia?</p>
                    </div>
                  </a>
                </div>
              </div>
        ...
        <div class="animated fadeIn">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="stat-widget-five">
                    ...
                    <div class="stat-content">
                      <div class="text-left dib">
                        <div class="stat-text"><span class="count">1435</span></div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="stat-widget-five">
                    ...
                    <div class="stat-content">
                      <div class="text-left dib">
                        <div class="stat-text"><span class="count">486</span></div>
                        <div class="stat-heading">Tamu</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="box-title">Traffic Penjualan</h4>
                </div>
                <div class="row">
                  <div class="col-lg-8">
                    <div class="card-body">
                  ...
                  <div class="col-lg-4">
                    <div class="card-body">
                      <div class="progress-box progress-1">
                        <h4 class="por-title">Berkunjung</h4>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>#5469</td>
                            <td><span class="name">Farhan Adi</span></td>
                            <td><span class="product">Avanza xenia</span></td>
                            <td><span class="count">1</span></td>
                            <td>
                              <span class="badge badge-complete">Sukses</span>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>#5468</td>
                            <td><span class="name">Friti Septiani</span></td>
                            <td><span class="product">Daihatsu</span></td>
                          ...
                          <tr>
                            ...
                            <td>#5467</td>
                            <td><span class="name">Caca marisa</span></td>
                            <td><span class="product">Honda</span></td>
                            <td><span class="count">1</span></td>
                            <td>
                              <span class="badge badge-complete">Sukses</span>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>#5466</td>
                            <td><span class="name">Silvia</span></td>
                            <td><span class="product">Fortuner</span></td>
                            <td><span class="count">1</span></td>
                            <td>
                          ...
                          <tr class="pb-0">
                            ...
                            <td>#5465</td>
                            <td><span class="name">Melki</span></td>
                            <td><span class="product">Jazz</span></td>
                            <td><span class="count">2</span></td>
                            <td>
                              <span class="badge badge-complete">Sukses</span>
                            </td>
                          ...
                          <div class="msg-received msg-container">
                            ...
                            <div class="msg-box">
                              <div class="inner-box">
                                ...
                                <div class="meg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis sunt placeat velit ad reiciendis ipsam</div>
                              </div>
                            </div>
                          </div>
                          <!-- /.msg-received -->
                        ...
                        <li>
                          <div class="msg-sent msg-container">
                            ...
                            <div class="msg-box">
                              <div class="inner-box">
                                <div class="name">John Doe</div>
                                <div class="meg">Hay how are you doing?</div>
                              </div>
                            </div>
                          </div>
                          <!-- /.msg-sent -->
