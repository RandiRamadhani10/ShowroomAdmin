...
function hapus($data)
{
    ...
    mysqli_query($conn, "DELETE FROM master WHERE id = '$id'");
...
tr:nth-child(even) {
  ...
  <body>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <div class="content">
          <div>
          <a href="tambah.php" class="btn btn-success text-light my-3">Tambah Data</a>
            <table>
              <tr>
                <th>Nama</th>
                <th>Nim</th>
              ...
              <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                  <tr>
                    ...
                    <td style="display:flex; justify-content:space-evenly;">
                      <a href="edit.php?id=<?= $row["id"]; ?>" class="btn btn-primary text-light">Edit</a>
