      ...
      <div style="width:70%;">
           ...
           <div style="display:flex; flex-direction:column; justify-content:center; margin:20px;">
            <div class="text-left dib">
                <div class="stat-text">Rp.<span class="count">1435000000</span></div>
                <div class="stat-heading"><P>Penghasilan</P></div>
            </div>
            <div class="text-left dib">
                <div class="stat-text"><span class="count">345</span> Unit</div>
                <div class="stat-heading"><P>Penjualan</P></div>
            </div>
           </div>
      </div>
        <!-- .animated -->
